...
export default function BookingsPage() {
  ...
  const filteredBookings = bookings.filter((booking) => {
    ...
    // 4. Event Type filter
    if (selectedEventTypeId !== "all" && booking.eventType.id !== selectedEventTypeId) {
      return false;
    }
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filters Section */}
      <div className={clsx('bg-white', 'border', 'border-[#E4E1D4]', 'rounded-2xl', 'p-5', 'shadow-[3px_3px_0_rgba(23,22,20,0.08)]', 'space-y-4')}>
      ...
      {bookings.length === 0 ? (
        ...
        <div className={clsx('bg-white', 'border', 'border-[#E4E1D4]', 'rounded-2xl', 'p-12', 'text-center', 'shadow-[3px_3px_0_rgba(23,22,20,0.08)]', 'space-y-3')}>
          <Search className={clsx('w-10', 'h-10', 'text-[#171614]', 'opacity-50', 'mx-auto')} />
          <h4 className={clsx('font-cal-sans', 'text-sm', 'font-bold', 'uppercase', 'tracking-wider', 'text-[#171614]')}>
