...
function CallyHero() {
  return (
    <section className="bg-[#F3E75B] relative py-[70px] overflow-hidden">
      <div className="max-w-[820px] mx-auto px-8 text-center relative z-2">
        ...
        <h1 className="text-[34px] md:text-[58px] font-bold leading-[1.08] tracking-[-0.01em] uppercase text-[#171614]">
          Booking meetings with a <span className="inline-block bg-[#7CEFC0] text-[#171614] px-[18px] py-1 pb-2 rounded-xl border-3 border-[#171614] -rotate-3 shadow-[6px_6px_0_#171614] ml-1.5">WILD SIDE</span>
        </h1>
        ...
        <div className="mt-[34px] flex justify-center">
          <a 
            href="#cta" 
            className="inline-flex items-center gap-2 font-bold text-[15px] px-[26px] py-3.5 rounded-full border-2 border-[#171614] transition-all bg-[#171614] text-[#FDFBF2] shadow-[3px_3px_0_#171614] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[5px_5px_0_#171614]"
          >
            Create Your Link
...
function CallyCTA() {
  ...
  return (
    <section className="bg-[#FDFBF2] text-center py-[120px] px-0 pb-[90px]" id="cta">
      <div className="max-w-[1180px] mx-auto px-8">
        <h2 className="text-[28px] md:text-[50px] font-bold uppercase leading-1.15 text-[#171614]">
          <span className="text-transparent [webkit-text-stroke:1.5px_#E4E1D4]">Ready to end scheduling</span>{" "}
          <span className="inline-block bg-[#7CEFC0] border-3 border-[#171614] rounded-[14px] px-5 pt-0.5 pb-2 shadow-[6px_6px_0_#171614] rotate-2 ml-2">Chaos?</span>
        </h2>
        <p className="mt-[22px] text-[#2B2A27] text-base leading-1.6 max-w-[520px] mx-auto">Join thousands of teams already booking smarter with Cally. Get started free — no credit card required.</p>
        <div className="mt-[38px] flex gap-4 justify-center flex-wrap">
          <a href="#" className="flex items-center gap-2.5 bg-[#171614] text-[#FDFBF2] px-[26px] py-[13px] rounded-[14px] font-bold text-sm border-2 border-[#171614]">Get Started Free</a>
          <a href="#" className="flex items-center gap-2.5 bg-white text-[#171614] hover:bg-[#F3E75B] px-[26px] py-[13px] rounded-[14px] font-bold text-sm border-2 border-[#171614] transition-all">▶ Book a Demo</a>
        </div>
        <p className="mt-9 text-xs font-bold text-[#2B2A27]">Or join the waitlist</p>
        <form className="mt-4 flex justify-center gap-2.5 flex-wrap" onSubmit={(e) => { e.preventDefault(); setNotified(true); }}>
          <input 
            type="email" 
            placeholder="enter your email..." 
            required 
            className="font-inherit text-sm px-5 py-3.5 rounded-full border-2 border-[#171614] w-[280px] max-w-[80vw] bg-white text-[#171614] focus:outline-none focus:ring-3 focus:ring-[#B7ACF7] transition-all font-semibold"
          />
          <button 
            type="submit" 
            className="font-bold text-sm px-[26px] py-3.5 rounded-full border-2 border-[#171614] bg-[#171614] text-[#FDFBF2] shadow-[3px_3px_0_#171614] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[5px_5px_0_#171614] transition-all cursor-pointer"
          >
