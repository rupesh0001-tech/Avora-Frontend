            ...
            <div className="flex items-center gap-4">
              <div className="relative w-64">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-1.5 border-2 border-[#171614] rounded-xl text-xs bg-white focus:outline-none focus:outline-2 focus:outline-[#B7ACF7] transition-all font-semibold text-[#171614] placeholder-[#2B2A27]/60"
                />
              </div>
              <button className="flex items-center justify-center gap-1.5 bg-[#171614] text-[#FDFBF2] text-xs font-bold px-4 py-2 rounded-xl border-2 border-[#171614] shadow-[2px_2px_0_#171614] hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[3px_3px_0_#171614] transition-all cursor-pointer">
